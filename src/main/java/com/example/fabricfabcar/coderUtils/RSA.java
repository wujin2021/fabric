...
public class RSA {
    ...
    //同态加密乘
    public static BigInteger encrypt_multiply(BigInteger em1,BigInteger em2,SecretKey.PublicKey publicKey) {
        return em1.multiply(em2).mod(publicKey.n);
    }
    ...
    public static void main(String[] args) {
        ...
        BigInteger em1 = RSA.encrypt(m1, secretKey.getPublicKey());
        BigInteger em2 = RSA.encrypt(m2, secretKey.getPublicKey());
        BigInteger sume = RSA.encrypt_multiply(em1,em2, secretKey.getPublicKey());
        BigInteger sum = RSA.decrypt(sume, secretKey.getPrivateKey());
